...
interface CommonElementsProps {
  ...
  setShowDonationSuccess: (show: boolean) => void;
  showContestRegistrationModal: boolean;
  setShowContestRegistrationModal: (show: boolean) => void;
  selectedContest: any;
  setSelectedContest: (contest: any) => void;
}
...
const CommonElements = ({
  ...
  showDonationSuccess,
  setShowDonationSuccess,
  showContestRegistrationModal,
  setShowContestRegistrationModal,
  selectedContest,
  setSelectedContest
}: CommonElementsProps) => (
  <>
...
interface FooterProps {
  socialLinks: any;
  setView: (view: 'home' | 'privacy' | 'cookie') => void;
}

export const Footer = ({ socialLinks, setView }: FooterProps) => (
    ...
    <div className="min-h-screen bg-stone-50 font-sans text-stone-900 selection:bg-stone-200">
      ...
      <Routes>
        ...
        <Route path="/news" element={
          <>
            <NewsPage 
              onNewsClick={(item: any) => setSelectedNews(item)}
              onLoginClick={() => setShowLoginModal(true)}
              onRegisterClick={() => setShowRegistrationModal(true)}
              onDonationClick={() => setShowDonationModal(true)}
            />
      ...
      <CommonElements 
        ...
        showContestRegistrationModal={showContestRegistrationModal}
        setShowContestRegistrationModal={setShowContestRegistrationModal}
